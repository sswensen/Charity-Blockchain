...
import CharityContainer from "./components/CharityContainer";
...
class App extends Component {
    ...
    componentDidMount = async() => {
        ...
        this.setState({
            charityNames: recievedCharityNames,
            numCharities: recievedNumCharities
        });
    };
                ...
                <div>
                    ...
                    <Card.Group>
                        {this.state.charityNames.map((name) =>
                            <CharityContainer name={name}></CharityContainer>
                        )}
                    </Card.Group>
